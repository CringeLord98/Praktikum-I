...
class StoritevController extends Controller
{
    ...
    {
        $this->middleware('auth',['except'=>['show','oceni','narocilo','naroci','komentiraj']]);
    ...
    public function show($id)
    {
        ...
        $komentarji = DB::select("SELECT k.created_at, k.komentar FROM komentar k JOIN storitev s ON k.storitev_id=s.id WHERE k.storitev_id='$id'");
        return view('storitev.show')->with(array('storitve'=>$storitev, 'komentarji'=>$komentarji));
    }
    ...
    public function komentiraj(Request $request,$id)
    {
        ...
        [
            'komentar.required' =>'Vnesi vsebino komentarja!',
            'komentar.max' =>'Komentar je predolg!'
        ]);
        $komentar = new Komentar;
        $komentar->komentar = $request->input('komentar');
        $komentar->storitev_id = $id;
        $komentar->save();
        return redirect("/storitve/".$id)->withErrors(['Komentar dodan!', 'The Message']);
    }
